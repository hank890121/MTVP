...
def parse_args():
    ...
    parser.add_argument('--logDir',
                        ...
                        type=str,
                        default='runs/')
    parser.add_argument('--weights', type=str, default='/media/jiao/39b48156-5afd-4cd7-bddc-f6ecf4631a79/zhanjiao/workspace/YOLOPX-main/weights/epoch-195.pth', help='model.pth path(s)')
