...
from .Head.segformer_head.build import build_seg_head

# from thop import profile
# from thop import clever_format

class RMSegLaneDet(nn.Module):
    ...
    def forward(self, sample_batch):
        ...
        lane_prediction = roi_dict
        if self.training:
            lane_prediction.update(rpn_dict)
        return lane_prediction
